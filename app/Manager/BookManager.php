<?php 
	...
	{
		public function getBooks($byNumber, $start, $bdlocCat)
		{	
			...
			$sql = "SELECT t.style AS catstyle, t.title AS ttitle, books.cover, books.title, books.id, books.stock, i.lastName AS ilastname, i.firstName AS ifirstname, s.lastName AS slastname, s.firstName AS sfirstname, c.lastName AS clastname, c.firstName AS cfirstname
					FROM $this->table					
